#ifndef SPQLIOS_REIM_FFT_PUBLIC_H
#define SPQLIOS_REIM_FFT_PUBLIC_H
...
typedef struct reim_innerprod_precomp REIM_FFTVEC_INNERPROD_PRECOMP;
...
#endif  // SPQLIOS_REIM_FFT_PUBLIC_H
