	.p2align 4
	.globl	reim_ifft_avx2_fma
	.type	reim_ifft_avx2_fma, @function
reim_ifft_avx2_fma:
	.globl	_reim_ifft_avx2_fma
_reim_ifft_avx2_fma:
//c has size n/2
//void fft(const void* tables, double* c) {

//    FFT_PRECOMP* fft_precomp = (FFT_PRECOMP*) tables;
//    const int32_t n = fft_precomp->n;
//    const double* trig_precomp = fft_precomp->trig_precomp;
	...
	movq         8(%rax), %rdx  /* rdx: n (logical Size of _fft  = a power of 2, must be at least 4) */
	movq         16(%rax), %r8   /* r8: Base address of trigonometric tables array (CONSTANT) */
...
.size	reim_ifft_avx2_fma, .-reim_ifft_avx2_fma
