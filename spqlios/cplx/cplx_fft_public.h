#ifndef SPQLIOS_CPLX_FFT_PUBLIC_H
#define SPQLIOS_CPLX_FFT_PUBLIC_H
...
typedef struct cplx_innerprod_precomp CPLX_FFTVEC_INNERPROD_PRECOMP;
...
EXPORT CPLX_FFTVEC_INNERPROD_PRECOMP* new_cplx_fftvec_innerprod_precomp(uint32_t m);
EXPORT void cplx_fftvec_innerprod(const CPLX_FFTVEC_INNERPROD_PRECOMP* tables, const int32_t ellbar, const uint64_t lda,
                                  const uint64_t ldb, void* r, const void* a, const void* b);
#define delete_cplx_fftvec_innerprod_precomp free
